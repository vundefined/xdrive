...
public class LogoutFilter extends AdviceFilter {
     ...
     * {@link #getRedirectUrl(jakarta.servlet.ServletRequest, jakarta.servlet.ServletResponse, org.apache.shiro.subject.Subject) redirectUrl},
     ...
     * {@code WebUtils.}{@link WebUtils#issueRedirect(jakarta.servlet.ServletRequest, jakarta.servlet.ServletResponse, String) issueRedirect(request,response,redirectUrl)}.
     *
     * @param request  the incoming Servlet request
     * @param response the outgoing Servlet response
