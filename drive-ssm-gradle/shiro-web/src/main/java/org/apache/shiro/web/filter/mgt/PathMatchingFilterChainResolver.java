...
public class PathMatchingFilterChainResolver implements FilterChainResolver {
    ...
    /**
     * Merely returns
     * <code>WebUtils.{@link org.apache.shiro.web.util.WebUtils#getPathWithinApplication(jakarta.servlet.http.HttpServletRequest) getPathWithinApplication(request)}</code>
