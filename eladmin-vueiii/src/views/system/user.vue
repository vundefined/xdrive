<template>
    <div class="table-box">
        ...
        <el-table ref="multipleTableRef" :data="tableData.list" row-key="id" @selection-change="handleSelectionChange">
...
<script setup>
    ...
    onMounted(() => {
        queryData();
        HttpConnection.get("sysRolePage", {params: {curPage: 1, limit: 10}}).then((response) => {
