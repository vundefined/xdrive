...
DROP TABLE IF EXISTS `teacher_car`;
...
DROP TABLE IF EXISTS `drive_license_class`;
...
DROP TABLE IF EXISTS `teacher_of_student`;
...
DROP TABLE IF EXISTS `qr_recommend`;
...
DROP TABLE IF EXISTS `qr_invite`;
...
DROP TABLE `appointment_class_during`
